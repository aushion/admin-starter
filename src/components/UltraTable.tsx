...
export default defineComponent({
    ...
    emits: ['page-change', 'page-size-change', 'sort-change', 'update:selectedRowKeys', 'selection-change', 'loaded'],
                    ...
                    {{
                        ...
                        default: (scope: any) => {
                            ...
                            if (typeof col.render === 'function') {
                                ...
                                return col.render({ row: scope.row, column: scope.column, $index: scope.$index, cellValue })
                            }
